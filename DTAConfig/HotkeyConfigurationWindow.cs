...
namespace DTAConfig
{
    ...
    {
        private string HOTKEY_TIP_TEXT = LocaleKey.HotKey_lblNewHotkeyValue.Lang();
        ...
        public override void Initialize()
        {
            ...
            lblCategory.Text = LocaleKey.HotKey_lblCategory.Lang();
            ...
            lbHotkeys.AddColumn(LocaleKey.HotKey_lbCommand.Lang(), 150);
            lbHotkeys.AddColumn(LocaleKey.HotKey_lbShortcut.Lang(), lbHotkeys.Width - 150);
            ...
            lblCommandCaption.Text = LocaleKey.HotKey_lblCommandCaption.Lang();

             lblDescription = new XNALabel(WindowManager);
            lblDescription.Name = "lblDescription";
            lblDescription.ClientRectangle = new Rectangle(12, lblCommandCaption.Bottom + 12, 0, 0);
            lblDescription.Text = LocaleKey.HotKey_lblDescription.Lang();
            ...
            lblCurrentHotkey.Text = LocaleKey.HotKey_lblCurrentHotkey.Lang();
            ...
            lblCurrentHotkeyValue.Text = LocaleKey.HotKey_lblCurrentHotkeyValue.Lang();
            ...
            lblNewHotkey.Text = LocaleKey.HotKey_lblNewHotkey.Lang();
            ...
            lblCurrentlyAssignedTo.Text = LocaleKey.HotKey_lblCurrentlyAssignedTo.Lang();
            ...
            btnAssign.Text = LocaleKey.HotKey_btnAssign.Lang();
            ...
            btnResetKey.Text = LocaleKey.HotKey_btnResetKey.Lang();
            ...
            lblDefaultHotkey.Text = LocaleKey.HotKey_lblDefaultHotkey.Lang() + Environment.NewLine;
            ...
            btnResetAllKeys.Text = LocaleKey.HotKey_btnResetAllKeys.Lang();
        ...
        private void Keyboard_OnKeyPressed(object sender, Rampastring.XNAUI.Input.KeyPressEventArgs e)
        {
            ...
            foreach (var command in gameCommands)
            {
                if (pendingHotkey.Equals(command.Hotkey))
                    lblCurrentlyAssignedTo.Text = LocaleKey.HotKey_lblDefaultHotkey.Lang() + Environment.NewLine + command.UIName;
            }
        }
        ...
        struct Hotkey
        {
            ...
            {
                if (Key == Keys.None && Modifier == KeyModifiers.None)
                    return LocaleKey.HotKey_none.Lang();
